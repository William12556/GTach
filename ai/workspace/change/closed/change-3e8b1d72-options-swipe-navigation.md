...
verification:
  ...
  implemented_by: "Claude Code, per prompt-3e8b1d72"
  ...
  test_results: >
    ...
    line. Source re-check 2026-08-07 confirms both swipe handlers
    registered in touch.py and the long press retired from OPTIONS.
    William confirmed 2026-08-07 that GTach functions correctly on
    gtach.local.
  issues_found:
    - "A stale 'Long press to return' footer text survived in _draw_update_view, carried forward at the operator's request per report §6.2; raised and grouped under issue-c1d4b8e6."
