...
| `bdac4f18` | ACKNOWLEDGEMENT screen body/instruction text clips the circular viewport (single-line Michroma render, no word-wrap); rewrite with pinned, on-device-measured plain-font lines (blocked by `e22142da`) | Open — prompt ready to execute: `implement ai/workspace/prompt/prompt-bdac4f18-acknowledgement-screen-layout.md` in Claude Code | `issue-bdac4f18`, `change-bdac4f18`, `prompt-bdac4f18` |
